...
def _copy_logic_tooltip() -> str:
    ...
    return (
        ...
        "<b>Always Skipped (Aggressive Filter):</b><br>"
        ...
        "- <b>Active DB States:</b> <code>.sqlite-wal/-shm</code>, <code>.db-wal/-shm</code>, <code>journal</code>, <code>.ldb</code>, <code>.log</code><br>"
        "- <b>Web Storage:</b> <code>idb/</code> (IndexedDB), <code>storage/default/</code>, <code>Session Storage</code>, <code>leveldb/</code><br>"
        "- <b>System &amp; Temp:</b> <code>Thumbs.db</code>, <code>.DS_Store</code>, <code>.tmp</code>, <code>.bak</code>, <code>.baklz4</code>, <code>recovery.jsonlz4</code><br><br>"
