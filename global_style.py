...
QPushButton {
    border: 2px solid #7dcfff; height: 23px;
...
QPushButton:enabled:hover, QPushButton:enabled:focus {
    ...
    color: #55ffff; outline: none;
}
QPushButton:disabled { border: 2px solid #444; color: #616161; background-color: #282828; }
QCheckBox { background-color: transparent; border: 2px solid transparent; }
QCheckBox:enabled:hover, QCheckBox:enabled:focus {
    border: 2px solid #ffff00; color: #55ffff; outline: none;
}
...
QLabel {
    color: #c0caf5; border: none; border-radius: 2px; padding: 5px;
    qproperty-alignment: 'AlignCenter';
}
QWidget[class="container"] { background-color: #222; border-radius: 5px; }
QLineEdit { background-color: #555582; color: #aaff00; padding: 5px; border-radius: 8px; }
...
QScrollBar:vertical { border: none; background: #2d2d44; width: 14px; margin: 15px 0; }
QScrollBar::handle:vertical { background-color: #4f4f78; min-height: 30px; border-radius: 7px; }
QScrollBar::handle:vertical:hover, QScrollBar::handle:vertical:pressed { background-color: #9090dc; }
...
QProgressBar {
    ...
    height: 22px; text-align: center; margin: 10px 0; font-weight: bold; color: #000000;
}
QProgressBar::chunk {
...
QPushButton, QCheckBox {
    border-radius: 10px; outline: none; text-align: center; padding: 3px; font-weight: bold; color: #ffffff;
}
...
QCheckBox { background-color: transparent; border: 2px solid transparent; }
QCheckBox:enabled:hover, QCheckBox:enabled:focus { border: 2px solid #888; color: #ffffff; outline: none; }
...
QPushButton, QCheckBox {
    border-radius: 10px; outline: none; text-align: center; padding: 3px; font-weight: bold; color: #333333;
}
...
QCheckBox { background-color: transparent; border: 2px solid transparent; }
QCheckBox:enabled:hover, QCheckBox:enabled:focus { border: 2px solid #0078d4; color: #0078d4; outline: none; }
...
QPushButton, QCheckBox {
    border-radius: 10px; outline: none; text-align: center; padding: 3px; font-weight: bold; color: #ebdbb2;
}
...
QCheckBox { background-color: transparent; border: 2px solid transparent; }
QCheckBox:enabled:hover, QCheckBox:enabled:focus { color: #b8bb26; border: 2px solid #b8bb26; outline: none; }
...
QPushButton, QCheckBox {
    border-radius: 10px; outline: none; text-align: center; padding: 3px; font-weight: bold; color: #eceff4;
}
...
QCheckBox { background-color: transparent; border: 2px solid transparent; }
QCheckBox:enabled:hover, QCheckBox:enabled:focus { color: #aaff00; border: 2px solid #85c199; outline: none; }
...
QPushButton, QCheckBox {
    border-radius: 10px; outline: none; text-align: center; padding: 3px; font-weight: bold; color: #cdd6f4;
}
...
QCheckBox { background-color: transparent; border: 2px solid transparent; }
QCheckBox:enabled:hover, QCheckBox:enabled:focus { color: #00ffc8; border: 2px solid #f5c2e7; outline: none; }
...
QPushButton, QCheckBox {
    border-radius: 10px; outline: none; text-align: center; padding: 3px; font-weight: bold; color: #f8f8f2;
}
...
QCheckBox { background-color: transparent; border: 2px solid transparent; }
QCheckBox:enabled:hover, QCheckBox:enabled:focus { color: #a6e22e; border: 2px solid #a6e22e; outline: none; }
...
def apply_theme_to_widget(widget: QWidget, theme_name: str | None = None) -> None:
    ...
    style_sheet = get_current_style()
    widget.setStyleSheet(style_sheet)
    for child in widget.findChildren(QWidget):
        child_widget: QWidget = child
